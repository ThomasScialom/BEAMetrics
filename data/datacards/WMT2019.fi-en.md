# Table card: WMT2019.fi-en (WMT.fi-en)

This table card grasp all the information for WMT2019.fi-en. The specific definition of each field is available at this [link](https://github.com/ThomasScialom/BEAMetrics#adding-a-new-dataset).
